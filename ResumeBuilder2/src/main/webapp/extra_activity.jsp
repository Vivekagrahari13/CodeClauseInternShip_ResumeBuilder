	...
	<div class="container">
		...
		<form action="extras" method="post">
			...
			<textarea maxlength="300" class="width1" type="text" name="extra"
				placeholder="not more than 300 character" required></textarea><br>
			Add your two unique hobbies:<br>
			<input type="text" name="hobby1"
				placeholder="like reading novel, travelling etc." required />
			<br>
			...
			<div class=" card-content container1 text-center">
				...
				<button 
					...
					<a href="generateResume.jsp">Add & Next</a>
				</button>
				</div>
			</div>
			<hr>
